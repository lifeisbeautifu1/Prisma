...
const Hero = () => {
  ...
  return (
    <div className="bg-gray-100/40 py-10 md:py-16 mt-[66px]">
      <div className="w-[90%] lg:w-[85%] mx-auto h-full flex  flex-col lg:flex-row gap-8 items-center">
        <div className="flex-[0.60]  mt-8 ">
        ...
        <div className="flex-[0.40] self-stretch lg:self-center  cursor-pointer">
          ...
          <img
            ...
            src="https://website-v9.vercel.app/illustrations/home-page/video-thumbnail-homepage.png"
            alt="What Is Prisma?"
          />
        </div>
      </div>
