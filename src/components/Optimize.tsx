...
const Optimize = () => {
  ...
  return (
    <div className="bg-[#f7fafc] flex flex-col gap-20  py-10 md:py-20">
      <div className="w-[90%] mx-auto md:w-[80%] flex flex-col">
        <div className="flex flex-col items-center mb-8">
          <h1 className="text-[32px] md:text-[48px] font-secondary font-bold text-gray-700 tracking-[-.02em] text-center">
            Optimize Prisma for production workflows
          </h1>
          <p className="text-[18px] md:text-[24px] text-gray-500 font-[300] text-center mt-2 md:mt-0">
      ...
      <div className="w-[90%] mx-auto lg:min-w-[80%] flex flex-col md:flex-row justify-between gap-8 items-center mt-8 md:mt-0">
        <div className="w-full md:w-[50%] flex flex-col gap-12">
          <div className="flex items-center text-[20px] font-semibold justify-center">
            <button
          ...
          {isWithProxy ? (
            <img
              src="https://www.prisma.io/home-page/optimise-1-with-the-proxy.svg"
              alt="Data"
            />
          ) : (
            <img
              src="https://www.prisma.io/home-page/optimise-1-without-the-proxy.svg"
              alt="Data"
            />
          )}
        </div>
