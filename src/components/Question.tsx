  ...
  return (
    <div>
      <div className="pt-24 pb-12 w-[90%] lg:w-[85%] mx-auto flex flex-col gap-4 items-center">
        ...
        <img
          className="mt-12"
          src="https://website-v9.vercel.app/diagrams/home-page/prisma-stack-fit.svg"
          alt="stack-fit"
        />
      </div>
      <div className="bg-white rounded shadow-xl border border-gray-100 p-12 w-[90%] lg:w-[85%] mx-auto flex flex-col gap-2 mb-20">
        ...
        <div className="mt-12 mb-8 flex gap-12 flex-wrap items-center justify-center">
          <div>
            <img
              src="https://website-v9.vercel.app/icons/technologies/home-page/nextjs.svg"
              alt="NextJS"
            />
          </div>
          <div>
            <img
              src="https://website-v9.vercel.app/icons/technologies/home-page/graphql.svg"
              alt="GraphQL"
            />
          </div>
          <div>
            <img
              src="https://website-v9.vercel.app/icons/technologies/home-page/apollo.svg"
              alt="Apollo"
            />
          </div>
          <div>
            <img
              src="https://website-v9.vercel.app/icons/technologies/home-page/hapi.svg"
              alt="Hapi"
            />
          </div>
          <div>
            <img
              src="https://website-v9.vercel.app/icons/technologies/home-page/nest.svg"
              alt="Nest"
            />
          </div>
          <div>
            <img
              src="https://website-v9.vercel.app/icons/technologies/home-page/express.svg"
              alt="Express"
            />
          </div>
        </div>
