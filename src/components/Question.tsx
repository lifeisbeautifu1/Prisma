  ...
  return (
    <div>
      <div className="pt-24 pb-12 w-[90%] lg:w-[80%] mx-auto flex flex-col gap-4 items-center">
        <h1 className="text-gray-800 font-secondary text-[32px] md:text-[48px] font-bold">
      ...
      <div className="bg-white rounded shadow-xl border border-gray-100 p-12 w-[90%] lg:w-[80%] mx-auto flex flex-col gap-2 mb-20">
        ...
        <div className="flex flex-col md:flex-row  justify-center gap-4 mt-4">
          <button className="py-3 px-6 bg-secondary hover:bg-primary text-white rounded shadow-xl text-[18px]">
            Browse Examples on GitHub
          </button>
          <button className="py-3 px-6 border-2 border-secondary hover:border-primary hover:text-primary text-secondary rounded shadow-xl text-[18px]">
