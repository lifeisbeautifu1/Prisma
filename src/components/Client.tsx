      ...
      <div className="pt-16 pb-8 w-[90%] lg:w-[85%] mx-auto flex flex-col md:flex-row items-center gap-8">
        <div className="w-full md:w-1/2">
          <img
            ...
            src="https://website-v9.vercel.app/illustrations/home-page/typesafe-database-client.svg"
            alt="Client"
          />
        </div>
      ...
      <div className="w-[90%] pt-8 pb-12 lg:w-[85%] mx-auto flex flex-col md:flex-row items-center gap-8">
        <div className="w-full md:w-1/2 flex flex-col md:flex-row gap-4">
          <div className="h-20 w-20 md:w-40">
            <img
              src="https://website-v9.vercel.app/icons/technologies/vscode.svg"
              alt="VSCode"
        ...
        <div className="w-full md:w-1/2 flex gap-4 flex-col md:flex-row">
          <div className="h-20 w-20 md:w-40">
            <img
              src="https://website-v9.vercel.app/icons/technologies/ts-framed.svg"
              alt="VSCode"
              className="h-full w-full object-contain"
            />
          </div>
