const Data = () => {
  return (
    <div>
      <div className="w-[90%]  mx-auto lg:w-[85%] flex flex-col md:flex-row justify-between gap-8 items-center mt-8">
        ...
        <div className="w-full md:w-[50%]">
          <img
            src="https://website-v9.vercel.app/illustrations/home-page/schema.svg"
            alt="Data"
          />
        </div>
      </div>
